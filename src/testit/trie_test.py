...
class TestTrie(unittest.TestCase):
    ...
    def test_lisaa_yksi_sanapari(self):
        ...
        self.assertEqual(self.trie.aloitussolmu.lapset['Minä'].lapset['olen'].frekvenssi, 1)
        self.assertEqual(self.trie.aloitussolmu.lapset['Minä'].lapset['olen'].on_lehtisolmu, True)

    def test_lisaa_yksi_sanakolmikko(self):
        sanakolmikko = ['Minä', 'olen', 'ihminen']
        self.trie.lisaa(sanakolmikko)

        self.assertEqual(self.trie.aloitussolmu.lapset['Minä'].lapset['olen'].lapset['ihminen'].frekvenssi, 1)
        self.assertEqual(self.trie.aloitussolmu.lapset['Minä'].lapset['olen'].lapset['ihminen'].on_lehtisolmu, True)
    ...
    def test_lisaa_kaksi_sanaparia_yksi_paallekkaisuus(self):
        ...
        self.assertEqual(self.trie.aloitussolmu.lapset['Minä'].lapset['olen'].frekvenssi, 1)
        self.assertEqual(self.trie.aloitussolmu.lapset['Minä'].lapset['en'].frekvenssi, 1)
    ...
    def test_lisaa_kaksi_sanaparia_kaksi_paallekkaisyytta(self):
        ...
        self.assertEqual(self.trie.aloitussolmu.lapset['Minä'].lapset['olen'].frekvenssi, 2)
